...
public class ArchitectureApplication {
  ...
  public static void main(String[] args) {
    System.out.println(
        "Hola me llamo alberto estoy probando el formateo que funcione, sabes por que no me funciona, yo creo que "
            + "si escribes normal si te funciona, solo tienes que escribir de a me llamo akberto laguna me repito "
            + "addd a aa"
  ...
  private String test() {
    ...
    for (int a = 0; a < 10; a++) System.out.println("prueba");

    if (true) System.out.println("aa");
